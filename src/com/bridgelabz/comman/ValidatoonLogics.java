package com.bridgelabz.comman;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class ValidatoonLogics {
	final static String CAP_LATTER ="{1}^[A-Z]+[a-z].*";
	...
	final static String ID_CHECK ="{1}[A-Za-z0-9]|[@]|";
	...
	final static String EMAIL_CHECK ="{1}^[a-z]|[0-9]+[. - +]|[@,!,@,#,%.$.&.*]+gmail.com/z";
	...
	final static String ADDRESSID_CHECK ="^[A-Za-z]+[0-9]";
	...
	final static String ZipDIGIT_ONLY = "[0-9]{6}";
	public static void CheckAllDigit6(String input) {
		
		Pattern pattern = Pattern.compile(DIGIT_ONLY);
		Matcher matcher = pattern.matcher(input);
		
		if(!matcher.find()) {
			System.out.println("Please Enter Valid Digit zip Number:");
		}
   }
}
